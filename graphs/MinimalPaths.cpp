...
//     const WeightedUndirectedGraph<std::string>&, const size_t&);

// template void printBellmanFordResult<std::string>(
//     const WeightedUndirectedGraph<std::string>&, const size_t&,
//     const std::tuple<bool, std::vector<double>, std::vector<size_t>>&);

// template void Dijkstra<std::string>(
//     const WeightedUndirectedGraph<std::string>&, const std::string&);

// template void FloydWarshall<std::string>(
//     const WeightedUndirectedGraph<std::string>&);